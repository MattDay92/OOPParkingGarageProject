...
1) Matt created repository and added files
2) Matt structured the code, creating the class and the various methods used.  
    Lines 1 - 15
3) Switch Drivers
4) Calvin completed code for payForParking and began leaveGarage
    Lines 15 - 34
5) Switch Drivers
6) Matt finished leaveGarage
    Lines 27 - 44
7) Method run() was compiled throughout
